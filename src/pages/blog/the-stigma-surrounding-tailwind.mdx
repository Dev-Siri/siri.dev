...
As I had expected, <SocialMediaLink username="@t3dotgg" variant="twitter">Theo</SocialMediaLink> noticed the Tweet, the original Tweeter got the attention they wanted, and everyone moved one. End of cycle. Well, this is just one cycle, the cycle of an event that happens monthly.

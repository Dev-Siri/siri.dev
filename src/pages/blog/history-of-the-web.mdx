...
In 2008, Google released Chrome. But more importantly, it also introduced the V8 engine. The V8 Lars Bak for the first time actually Just-in-Time compiled the JavaScript leading to much better performance.
